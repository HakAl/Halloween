...
public class MultiStateView extends FrameLayout {
    ...
    @MultiStateViewState.ViewState
    private int mViewState = MultiStateViewState.CONTENT;
    ...
    private void init(AttributeSet attrs) {
        ...
        int viewState = a.getInt(R.styleable.MultiStateView_msv_viewState, MultiStateViewState.CONTENT);

        switch (viewState) {
            case MultiStateViewState.CONTENT:
                mViewState = MultiStateViewState.CONTENT;
                break;

            case MultiStateViewState.ERROR:
                mViewState = MultiStateViewState.ERROR;
                break;

            case MultiStateViewState.EMPTY:
                mViewState = MultiStateViewState.EMPTY;
                break;

            case MultiStateViewState.LOADING:
                mViewState = MultiStateViewState.LOADING;
                break;
        }
     ...
     */
    @Nullable
    public View getView(@MultiStateViewState.ViewState int state) {
        switch (state) {
            case MultiStateViewState.LOADING:
                return mLoadingView;
     ...
     */
    public void setViewState(@MultiStateViewState.ViewState int state) {
        if (state != mViewState) {
            mViewState = state;
            setView();
        }
     ...
     */
    public void setViewForState(View view, @MultiStateViewState.ViewState int state, boolean switchToState) {
        switch (state) {
            case MultiStateViewState.LOADING:
     ...
     * @param state The ViewState} to set
     */
    public void setViewForState(View view, @MultiStateViewState.ViewState int state) {
     ...
     * @param switchToState If the ViewState} should be switched to
     */
    public void setViewForState(@LayoutRes int layoutRes, @MultiStateViewState.ViewState int state, boolean switchToState) {
     ...
     */
    public void setViewForState(@LayoutRes int layoutRes, @MultiStateViewState.ViewState int state) {
